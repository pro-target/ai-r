...
- **Аудит сессий свежим взглядом.** Новый агент с пустым контекстом холодно
  проверяет прошлую сессию: выполнены ли обещания и требования, логичны ли
  решения, что упущено. Ловит случаи, когда задача сделана, **но по
  планированию тебя ввели в заблуждение** — то, что в живом чате не видно.
  Сотни прошлых диалогов за неделю уже так проверяются.
