...
**Детерминированный путь чтения (read path): разбор не зовёт LLM и не делает
исходящих сетевых запросов; опциональный семантический ре-ранк — тоже локальный
(эмбеддинги, не LLM).**
...
- Приёмочные сценарии (90 e2e) — [`docs/scenarios.md`](./docs/scenarios.md)
